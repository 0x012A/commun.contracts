...
public:
    ...
    */
    ...
    /**
        ...
        This action does not store any state in DB, it only checks input parameters.
        If commun_code is empty then check self authority.

        \signreq
            — <i>trusted community client</i> if \a commun_code is empty ;
            — <i>minority of community leaders</i> for existing community .
    */
